...
namespace WebApplication4_0
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void ButtonLogin_Click(object sender, EventArgs e)
        {
            ...
            if (temp == 1) //if entered username exists
            {
                Result.InnerHtml = "Username does exist";

            }
            else //if entered username does not exist
            {
                Result.InnerHtml = "Username does not exist";
            }
        }
    }
}